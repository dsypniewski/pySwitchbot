...
import switchbot.util.internal_api
...
class SwitchbotLock(SwitchbotDevice):
    ...
    def retrieve_encryption_key(device_mac: str, username: str, password: str):
        ...
        access_token = switchbot.util.internal_api.login(username, password)
        return switchbot.util.internal_api.retrieve_encryption_key(device_mac, access_token)
